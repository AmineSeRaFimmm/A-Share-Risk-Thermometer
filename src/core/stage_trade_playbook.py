...
STAGE_DEFS = [
    ...
    },
    {
        ...
        "sectors_short": [
            {"name": "美容护理", "why": "升温后显著跑输", "win_rate": 0.40, "n": 327, "horizon": "5D", "mean_excess": -0.004060},
            {"name": "房地产", "why": "升温后显著跑输；IS/OOS稳定为负", "win_rate": 0.42, "n": 438, "horizon": "5D", "mean_excess": -0.003840},
            {"name": "钢铁", "why": "升温后显著跑输", "win_rate": 0.42, "n": 438, "horizon": "5D", "mean_excess": -0.003050},
        ],
    ...
    },
    {
        ...
        "sectors_long": [
            {"name": "建筑材料", "why": "高风险区间[60,75) 未来5日超额显著、胜率~58%", "win_rate": 0.58, "n": 184, "horizon": "5D", "mean_excess": 0.0050},
            {"name": "商贸零售", "why": "高风险区间超额显著", "win_rate": 0.59, "n": 184, "horizon": "5D", "mean_excess": 0.0050},
            {"name": "传媒", "why": "高风险区间超额显著", "win_rate": 0.58, "n": 184, "horizon": "5D", "mean_excess": 0.0050},
            {"name": "恒生科技", "why": "高风险区间超额显著（弹性，仓位宜小于A股主仓）", "win_rate": 0.58, "n": 165, "horizon": "5D", "mean_excess": 0.0080},
        ],
        "sectors_short": [
            {"name": "公用事业", "why": "高风险区间相对偏弱（防御在升温冲击日才强）", "win_rate": 0.44, "n": 184, "horizon": "5D", "mean_excess": -0.0030},
            {"name": "银行", "why": "高风险区间相对不占优", "win_rate": 0.49, "n": 184, "horizon": "5D", "mean_excess": -0.0010},
        ],
        "hold_days": 5,
        "notes": [
            "这是全体系最高优先级的指数级指令。",
    ...
    },
    {
        ...
        "sectors_short": [
            {"name": "石油石化", "why": "进入≥70后5日显著跑输，胜率仅27%", "win_rate": 0.27, "n": 30, "horizon": "5D", "mean_excess": -0.012337},
            {"name": "公用事业", "why": "进入高风险后相对偏弱", "win_rate": 0.38, "n": 34, "horizon": "5D", "mean_excess": -0.009042},
            {"name": "银行", "why": "进入高风险后相对偏弱", "win_rate": 0.47, "n": 34, "horizon": "5D", "mean_excess": -0.007081},
        ],
        "hold_days": 5,
    ...
    },
    {
        ...
        "sectors_long": [
            ...
            {"name": "综合", "why": "高位回落超额+1.6%，胜率69%，显著", "win_rate": 0.69, "n": 39, "horizon": "5D", "mean_excess": 0.015661},
            {"name": "轻工制造", "why": "高位回落超额+1.5%，胜率69%，显著", "win_rate": 0.69, "n": 39, "horizon": "5D", "mean_excess": 0.014524},
            {"name": "煤炭", "why": "高位回落超额+1.5%，胜率59%，显著", "win_rate": 0.59, "n": 37, "horizon": "5D", "mean_excess": 0.014940},
            {"name": "传媒", "why": "高位回落超额+1.5%，胜率64%，显著", "win_rate": 0.64, "n": 39, "horizon": "5D", "mean_excess": 0.014803},
        ],
        "sectors_short": [
            {"name": "电子", "why": "高位回落阶段相对偏弱（均值负）", "win_rate": 0.49, "n": 39, "horizon": "5D", "mean_excess": -0.002096},
            {"name": "计算机", "why": "高位回落阶段相对偏弱", "win_rate": 0.44, "n": 39, "horizon": "5D", "mean_excess": -0.001737},
        ],
        "hold_days": 5,
        "notes": [
    ...
    },
    {
        ...
        "sectors_long": [
            ...
            {"name": "基础化工", "why": "降温后5日超额显著、胜率57%", "win_rate": 0.57, "n": 477, "horizon": "5D", "mean_excess": 0.002979},
            {"name": "电力设备", "why": "降温后5日超额显著", "win_rate": 0.53, "n": 477, "horizon": "5D", "mean_excess": 0.003273},
        ],
        "sectors_short": [
            {"name": "计算机", "why": "降温后显著跑输", "win_rate": 0.43, "n": 477, "horizon": "5D", "mean_excess": -0.003997},
            {"name": "传媒", "why": "降温后显著跑输", "win_rate": 0.44, "n": 477, "horizon": "5D", "mean_excess": -0.003221},
            {"name": "美容护理", "why": "降温后显著跑输", "win_rate": 0.42, "n": 339, "horizon": "5D", "mean_excess": -0.003069},
        ],
        "hold_days": 5,
