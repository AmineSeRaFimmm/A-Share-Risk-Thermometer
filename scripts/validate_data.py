...
from src.core.official_avix_quality import assess_official_avix
...
def main() -> None:
    ...
    if not avix.empty:
        ...
        assessment = assess_official_avix(tip)
        require(assessment.ready, f"latest AVIX not official-ready: {'|'.join(assessment.reasons)}")
